...
//   if (obj.node?.id && obj.node && !isComment(obj.node)) {
//     posts.push(obj.node);
//   }

//   if (obj.story?.id && obj.story && !isComment(obj.story)) {
//     posts.push(obj.story);
//   }

//   if (obj.edge?.node?.id && obj.edge.node && !isComment(obj.edge.node)) {
//     posts.push(obj.edge.node);
//   }

//   // Capture if it has ID AND any content indicators AND is not a comment
//   if (obj.id && typeof obj.id === "string" && !isComment(obj)) {
//     const hasContent = !!(
//       obj.message ||
//       obj.text ||
//       obj.body ||
